export default [
  ...
  {
    name: "Concurrence",
    text: `Le droit européen de la concurrence, fondé sur le principe d'une économie de marché libre et concurrentielle, comprend diverses interdictions et régulations. Il vise à maintenir une concurrence équitable et à prévenir toute distorsion du marché. Deux principales interdictions ciblent les entreprises privées : d'une part, l'interdiction des ententes, où plusieurs entreprises s'accordent pour fausser la concurrence, et d'autre part, l'interdiction des abus de position dominante, lorsque des entreprises exercent un pouvoir excessif sur un marché. La Commission européenne, en charge de l'application de ces règles, peut infliger des sanctions financières, même à des entreprises non-européennes, lorsque des pratiques anticoncurrentielles affectent le marché européen. Cela a été le cas en 2017 lorsque la Commission a infligé une amende de 2,42 milliards d’euros à Google.
        \nPar ailleurs, le droit de l'Union européenne interdit les aides d'État qui pourraient fausser la concurrence. Toutefois, des dérogations sont possibles pour certaines catégories d'aides, notamment celles liées à des besoins sociaux, bancaires, régionaux, ou en cas de catastrophe naturelle. Ces règles s'appliquent également aux services d'intérêt économique général (SIEG), tels que l'énergie, les transports, et les postes, où des exigences spécifiques sont imposées pour éviter les abus de position dominante.
...
\nLe processus s'est articulé autour de plusieurs jalons importants, notamment l'établissement de l'union douanière en 1968, l'Acte unique européen de 1986 qui a fixé l'achèvement du marché intérieur pour 1993, et le traité de Maastricht en 1992 qui a jeté les bases de l'adoption de l'euro comme monnaie unique, illustrant ainsi la progression vers une Europe économique intégrée et dynamique.`,
  ...
  },
  {
    ...
    text: `La politique sociale européenne est le résultat d'une construction progressive visant à harmoniser les politiques sociales au sein de l'Union européenne. Elle repose sur des interventions financières, telles que le cofinancement de projets sociaux par le Fonds Social Européen, et des interventions normatives, notamment à travers des directives sur le temps de travail et la lutte contre la discrimination au travail. Les domaines clés d'attention de l'Europe sociale sont l'emploi, la formation et la lutte contre la pauvreté, avec l'objectif de concilier efficacité économique et progrès social.
  
  La politique sociale européenne a souvent été entravée par la réticence des États membres à céder le contrôle de leur politique sociale, notamment avec l'adhésion de l'Irlande et du Royaume-Uni en 1973. Des critiques persistent également en raison de la quasi-inexistence perçue de l'Europe sociale, ce qui soulève des questions sur son adhésion. Malgré cela, des initiatives ont été prises, telles que la proposition de salaire minimum intra-UE et des régulations sur la négociation collective. La difficulté réside dans le fait que la question sociale relève encore de la souveraineté des États.
  
  L'Europe sociale ne vise pas à réduire les disparités nationales, mais plutôt à les rendre compatibles. Ce concept reste "flou" en raison des politiques sociales développées dans le cadre de l'État-nation, qui diffèrent du supranational. Les différentes conceptions au cours de la construction européenne incluent des projets d'harmonisation des systèmes nationaux, de dialogue social au sein des entreprises européennes, et de maintien des systèmes sociaux nationaux.
  
  Un retour historique sur la construction de l'Europe sociale montre une diversité des modèles sociaux européens, allant des modèles bismarckien et beveridgien au modèle libéral anglo-saxon, social-démocrate, et chrétien-démocrate. La lente construction de l'Europe sociale a traversé quatre étapes, de la dimension sociale dans le Traité de Rome à la rupture de 2005.
  
  Différentes politiques en matière sociale comprennent la politique de l'emploi, de la santé/sécurité sociale, de la parité des sexes, de lutte contre les discriminations, et de lutte contre la pauvreté. Ces politiques ont évolué au fil du temps, avec des objectifs tels que l'amélioration des conditions de travail, la protection de l'emploi, la promotion de l'égalité, et la réduction de la pauvreté.
  ...
  },
  {
    ...
    text: `La politique de cohésion de l'Union européenne vise à atténuer les disparités économiques et sociales entre ses États membres. Cette nécessité découle des divergences observées dans des domaines tels que le chômage, le coût du travail, et la protection sociale, illustrées par des variations importantes entre les pays membres, notamment après la crise financière de 2007.
  
  Les différences de taux de chômage, de coût du travail et de protection sociale révèlent des écarts significatifs entre les États membres de l'UE. Des pays tels que la Grèce, l'Espagne, l'Irlande et le Portugal ont connu une amplification brutale du chômage après la crise, tandis que l'Allemagne a enregistré un recul constant. Les coûts du travail varient considérablement, de la Bulgarie au Danemark, reflétant des différences de développement et de géographie économique.
  
  Les risques inhérents à ces disparités comprennent la concurrence déloyale, le dumping social et fiscal, ainsi que l'aggravation des désavantages pour les pays en retard de développement. La politique de cohésion, instaurée depuis les débuts de l'UE, cherche à répondre à ces défis en favorisant le développement des régions en retard, la reconversion des régions en déclin, la lutte contre le chômage, et l'intégration professionnelle des jeunes.
  ...
  },
  {
    ...
    text: `La Politique agricole commune (PAC) et la Politique commune de la pêche (PCP) sont deux piliers essentiels de l'Union européenne (UE), visant à réguler et à soutenir les secteurs agricole et de la pêche au sein de l'UE.
  
  La PAC, mise en place en 1962, est le principal poste de dépense de l'UE et bénéficie d'une série d'aides destinées à soutenir les agriculteurs. Ces aides comprennent notamment des mesures de soutien aux revenus, des outils de gestion et des initiatives de développement rural. En 2023, une nouvelle réforme de la PAC a été introduite pour répondre aux nouveaux défis et aux enjeux environnementaux.
  
  La France est le premier pays producteur agricole de l'UE et bénéficie largement de la PAC, avec environ 500 000 exploitations agricoles et un excédent net d'environ 6 milliards d'euros dans sa balance commerciale agricole en 2016.
  
  La PCP, quant à elle, est mise en place dans les années 1970 pour gérer de manière durable les ressources marines et réguler l'activité de la flotte de pêche européenne. En tant que troisième producteur mondial de poissons et premier importateur mondial, l'UE possède une économie maritime développée, reposant en grande partie sur la pêche.
  
  La Politique commune de la pêche a été établie en 1983 pour réglementer ce secteur spécifique et garantir une exploitation durable des ressources marines. Elle comprend des mesures visant à assurer une égalité d'accès aux eaux et aux fonds de pêche de l'UE, ainsi qu'à promouvoir une concurrence équitable entre les pêcheurs européens.
  ...
  {
    name: "Environnement",
    text: `La politique environnementale de l'Union européenne est guidée par des principes fondamentaux tels que la précaution, la prévention, la correction de la pollution à la source et le principe du "pollueur-payeur". Face à des défis environnementaux complexes, allant du changement climatique à la perte de biodiversité, l'UE a intégré la question environnementale au cœur de ses politiques.
  
  L'engagement de l'UE envers l'environnement remonte à plusieurs décennies. La directive "Oiseaux" de 1979 a jeté les bases de la politique environnementale européenne, qui a ensuite été formalisée dans l'Acte unique européen de 1986 et élargie avec le traité de Maastricht de 1992. Le traité d'Amsterdam de 1997 a reconnu le principe du développement durable, tandis que le traité de Lisbonne de 2007 a ajouté l'objectif de promotion de mesures environnementales internationales.
  
  La politique environnementale de l'UE s'appuie sur des objectifs ambitieux, notamment définis dans le huitième programme d'action pour l'environnement (2021-2030). Ces objectifs comprennent la réduction des émissions de gaz à effet de serre, l'adaptation au changement climatique, la transition vers une économie circulaire, la lutte contre la pollution et la protection de la biodiversité.
  
  Pour atteindre ces objectifs, l'UE a mis en place des mesures telles que le paquet "Fit for 55" présenté en 2021, qui vise à réduire les émissions de gaz à effet de serre. L'UE a également instauré un marché des quotas d'émission de carbone et un mécanisme d'ajustement carbone aux frontières pour encourager les industries à réduire leurs émissions.
  
  En plus de légiférer, l'UE finance des projets environnementaux à travers des programmes tels que LIFE et des fonds comme le Fonds pour une transition juste. Elle intègre également des considérations environnementales dans d'autres domaines d'action, tels que la Politique Agricole Commune et la politique de cohésion.
  ...
  },
  {
    ...
    text: `La protection des consommateurs est une priorité essentielle pour l'Union européenne, qui met en place des normes élevées pour garantir la sécurité, la santé et les intérêts économiques des consommateurs européens. La législation de l'UE en matière de protection des consommateurs couvre de nombreux aspects, allant de la sécurité des produits à la transparence des transactions.
  
  Principaux chiffres et faits :
  - Budget pour la protection des consommateurs : L'UE alloue des fonds spécifiques pour la protection des consommateurs, bien que les chiffres précis puissent varier selon les programmes et les périodes de financement.
  - Réseau de coopération pour la protection des consommateurs (CPC) : Ce réseau facilite la coopération entre les autorités nationales de l'UE pour lutter contre les pratiques déloyales et garantir l'application efficace des droits des consommateurs.
  - Le Nouveau Deal pour les Consommateurs : Une initiative visant à renforcer les droits des consommateurs dans l'UE, en réponse aux défis posés par la numérisation et les marchés en ligne.
  - Système RAPEX : Plus de 2 000 alertes sur des produits non alimentaires dangereux ont été signalées en 2019 via le système RAPEX, illustrant l'effort de l'UE pour garantir la sécurité des produits sur le marché.
  
  La législation et les initiatives de l'UE en matière de protection des consommateurs jouent un rôle crucial dans la promotion de la confiance des consommateurs et dans le fonctionnement efficace du marché intérieur, en assurant que les consommateurs sont bien informés, protégés contre les pratiques déloyales, et disposent de moyens de recours efficaces en cas de litige.
  ...
  {
    name: "Transport",
    text: `La politique des transports de l'Union européenne (UE) joue un rôle crucial dans le développement et la régulation des systèmes de transport au sein des États membres, visant à promouvoir des réseaux de transport efficaces, sûrs, et durables. Cette politique couvre tous les modes de transport, y compris aérien, maritime, ferroviaire, et routier, ainsi que les infrastructures de transport et la mobilité urbaine.
  
  L'UE vise à créer un espace européen unique des transports, facilitant la libre circulation des personnes, des biens, et des services. Ses objectifs comprennent l'amélioration de la compétitivité du secteur des transports, la garantie d'un haut niveau de sécurité et de protection environnementale, l'innovation, et le développement des infrastructures de transport trans-européennes (RTE-T ou TEN-T en anglais).
  
  L’UE finance de nombreux systèmes de transport urbain, notamment dans les pays d’Europe centrale et orientale. 
  
  La compétence de l'UE dans le domaine des transports est partagée avec les États membres, ce qui signifie que l'UE peut adopter des législations qui complètent les politiques nationales dans des domaines spécifiques, tels que :
  - La sécurité et la sûreté des transports, en établissant des normes communes pour tous les modes de transport.
  - La gestion du trafic, en développant des systèmes tels que le Ciel unique européen pour le trafic aérien ou le système européen de gestion du trafic ferroviaire (ERTMS).
  ...
  },
  {
    ...
    text: `La politique des réseaux transeuropéens (RTE) de l'Union européenne (UE) est une initiative stratégique visant à développer et intégrer les infrastructures de transport, d'énergie, et de télécommunications à travers les États membres. Cette politique joue un rôle crucial dans la promotion de la cohésion économique, sociale et territoriale au sein de l'UE, en facilitant la libre circulation des personnes, des biens et des services, et en renforçant la compétitivité.
  
  Objectifs et rôle des RTE
  
  Les RTE visent à connecter les régions périphériques aux centres économiques, à réduire les disparités régionales, à améliorer l'accès aux marchés intérieurs et internationaux, et à soutenir la transition vers une économie à faible émission de carbone. Les objectifs spécifiques incluent:
  - Améliorer les interconnexions transfrontalières pour faciliter le transport et le commerce.
  - Renforcer la sécurité énergétique en diversifiant les sources d'énergie et les itinéraires d'approvisionnement.
  - Développer les réseaux de télécommunications pour soutenir l'économie numérique.
  
  Compétence de l'UE et financement
  
  La compétence de l'UE en matière de RTE est partagée avec les États membres, permettant à l'UE de compléter les politiques nationales par des mesures au niveau européen. Le financement des projets RTE provient de plusieurs sources, y compris le budget de l'UE, les instruments financiers européens tels que la facilité pour l'interconnexion en Europe (MIE), les fonds structurels et d'investissement européens, ainsi que des investissements privés et nationaux.
  
  Les réseaux transeuropéens dans les secteurs clés
  - Transport (RTE-T) : Le réseau transeuropéen de transport vise à construire et à moderniser les infrastructures nécessaires pour relier les systèmes de transport à travers l'Europe, incluant les routes, les chemins de fer, les voies navigables, et les infrastructures portuaires et aéroportuaires.
  ...
  },
  {
    ...
    text: `L'Espace de liberté, de sécurité et de justice (ELSJ) trouve son origine dans le traité d'Amsterdam de 1997. Ce domaine englobe plusieurs dimensions, dont la politique des visas, de l'asile et de l'immigration, établissant une double logique. D'une part, elle vise à faciliter l'intégration des migrants légaux et à garantir une protection élevée pour les demandeurs d'asile, reflétant ainsi une logique "altruiste". D'autre part, elle cherche à contrer l'immigration illégale en renforçant les contrôles aux frontières extérieures de l'Union européenne, s'inscrivant dans une logique de "Europe forteresse".
  
  Dans le cadre de l'ELSJ, les politiques de coopération entre les polices et les systèmes judiciaires européens (CPJP) occupent également une place significative. Ces initiatives visent à renforcer la collaboration pour lutter contre le terrorisme et la grande criminalité, impliquant des organismes tels qu'Europol et le Mandat d'arrêt européen.
  
  Cependant, l'ELSJ, centré sur des questions régaliennes sensibles, souffre d'un déficit d'intégration. Cette lacune explique en grande partie les difficultés rencontrées par les États membres pour parvenir à un consensus, que ce soit dans le domaine des politiques migratoires, illustré par des tensions autour du système Schengen-Dublin, ou dans la lutte contre le terrorisme.
  ...
  },
  {
    ...
    text: `La recherche, la technologie et l'espace constituent des domaines clés dans lesquels l'Union européenne investit pour stimuler l'innovation, soutenir la croissance économique et renforcer sa position sur la scène internationale. Ces secteurs jouent un rôle crucial dans la réalisation des objectifs de l'UE en matière de développement durable, de compétitivité mondiale et de réponse aux défis sociétaux.
  
  1. Horizon Europe
  
  Horizon Europe est le programme-cadre de l'UE pour la recherche et l'innovation, couvrant la période 2021-2027, avec un budget de près de 95,5 milliards d'euros. Il succède à Horizon 2020 et vise à renforcer la base scientifique et technologique de l'Union, à stimuler sa capacité d'innovation et à répondre aux priorités politiques telles que le Pacte vert pour l'Europe, la numérisation et l'économie circulaire. Horizon Europe soutient la recherche collaborative entre les États membres, favorise l'excellence scientifique et encourage l'innovation dans les secteurs public et privé, y compris les petites et moyennes entreprises (PME).
  
  2. Galileo et Copernicus
  
  Dans le domaine spatial, l'UE a lancé des programmes ambitieux tels que Galileo et Copernicus. Galileo est le système global de navigation par satellite (GNSS) de l'UE, conçu pour fournir une alternative et une complémentarité aux systèmes GPS (États-Unis) et GLONASS (Russie). Copernicus est le programme d'observation de la Terre de l'UE, qui fournit des données précieuses pour la surveillance de l'environnement, le changement climatique et les interventions en cas de catastrophe naturelle ou humaine.
  
  3. European Innovation Council (EIC) et European Institute of Innovation and Technology (EIT)
  
  L'European Innovation Council et l'European Institute of Innovation and Technology sont deux initiatives clés de l'UE pour promouvoir l'innovation. L'EIC vise à identifier, développer et mettre à l'échelle des innovations de rupture et des technologies de pointe. L'EIT, quant à lui, renforce les capacités d'innovation de l'UE en rassemblant les meilleures ressources académiques, de recherche et d'entreprise pour former des partenariats dynamiques connus sous le nom de Communautés de la Connaissance et de l'Innovation (KICs).
  
  4. Investissement dans les Technologies Futures et Émergentes
  
  L'UE investit également dans les technologies futures et émergentes pour garantir son leadership dans des domaines tels que l'intelligence artificielle, la robotique, la blockchain et les nouvelles générations de technologies de l'information et de la communication. Ces investissements sont essentiels pour stimuler l'innovation, créer des emplois et répondre aux défis sociétaux.
...
\nLa politique culturelle de l'UE joue un rôle essentiel dans la valorisation et la préservation de la culture européenne, en encourageant la diversité culturelle et en soutenant le développement économique à travers les industries créatives. Elle vise à construire une Europe plus unie et inclusive, en reconnaissant la culture comme un pilier central de l'intégration européenne.`,
  ...
  },
  {
    ...
    text: `La politique de l'Union européenne (UE) dans les domaines de l'éducation, de la formation professionnelle, de la jeunesse et du sport vise à soutenir le développement personnel et professionnel des citoyens européens, à encourager la mobilité et l'apprentissage tout au long de la vie, et à promouvoir l'inclusion sociale et l'excellence dans le sport. Bien que l'éducation reste principalement une compétence des États membres, l'UE joue un rôle crucial en complétant et en soutenant les actions nationales à travers des programmes, des politiques et des financements.
        \n- La politique de l'UE dans ces domaines stratégiques est guidée par plusieurs objectifs principaux, conçus pour maximiser le potentiel de chaque citoyen et renforcer le tissu social de l'Union :
        \n- Favoriser la mobilité et l'apprentissage tout au long de la vie : Encourager les échanges d'étudiants, d'apprentis, d'enseignants et de travailleurs jeunes à travers l'Europe.
        \n- Améliorer la qualité et l'efficacité de l'éducation et de la formation : Soutenir l'innovation pédagogique et le développement des compétences clés nécessaires dans la société moderne.
        \n- Promouvoir l'équité, la cohésion sociale et l'engagement actif des jeunes : Assurer que tous ont accès à l'éducation et à la formation, et encourager la participation des jeunes à la vie démocratique.
        \n- Encourager le développement du sport et de l'activité physique : Soutenir des initiatives qui promeuvent la santé, l'inclusion sociale, l'égalité des chances et l'intégrité dans le sport.
        \nPour atteindre ces objectifs, l'UE déploie une série de compétences et d'instruments spécifiques :
        \n- Programme Erasmus+ : C'est le programme phare de l'UE pour l'éducation, la formation, la jeunesse et le sport, offrant des opportunités de mobilité et de coopération transnationale.
        \n- Cadre stratégique pour la coopération européenne dans le domaine de l'éducation et de la formation (ET 2020/ET 2030) : Il fournit une plate-forme pour échanger des bonnes pratiques, des informations et des conseils politiques entre les États membres.
        \n- Stratégie de l'UE pour la jeunesse : Vise à encourager les jeunes à participer activement à la société et à améliorer leur accès à l'éducation, à l'emploi et à la participation civique.
        \n- Plan de travail de l'UE pour le sport : Fournit un cadre pour la coopération entre les États membres et la Commission dans le domaine du sport.
